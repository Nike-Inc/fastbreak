...
/**
 * Tests the functionality of {@link CircuitBreakerException}.
 *
 * @author Nic Munroe
 */
public class CircuitBreakerExceptionTest {
    ...
    public void constructor_with_circuitBreakerId_and_message_works_as_expected() {
        ...
        // when
        CircuitBreakerException ex = new CircuitBreakerException(cbId, message) {};
    ...
    public void constructor_with_circuitBreakerId_and_message_and_cause_works_as_expected() {
        ...
        // when
        CircuitBreakerException ex = new CircuitBreakerException(cbId, message, cause) {};
    ...
    public void constructor_with_circuitBreakerId_and_cause_works_as_expected() {
        ...
        // when
        CircuitBreakerException ex = new CircuitBreakerException(cbId, cause) {};
